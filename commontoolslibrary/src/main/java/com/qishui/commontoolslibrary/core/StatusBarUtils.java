...
public class StatusBarUtils {
    ...
    /**
     * 添加人: add by qishui
     * 添加时间: 2019/3/15  16:09
     * 添加注释:设置底部颜色
     */
    public static void setNavigationBarColor(Activity activity, int color, int alpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            activity.getWindow().setNavigationBarColor(calculateStatusColor(color, alpha));
    ...
    public static void setNavigationBarColor(Activity activity, int color) {
        setNavigationBarColor(activity, color, DEFAULT_STATUS_BAR_ALPHA);
    }

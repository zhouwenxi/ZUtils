...
public class RatingStarView extends View implements View.OnClickListener {
    ...
    private void loadAttributes(AttributeSet attrs, int defStyle) {
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RatingStarView, defStyle, 0);
    ...
    private void calcStars() {
        ...
        Log.d(TAG, "drawing starCount = " + starCount + ", contentWidth = " + contentWidth + ", startWidth = " + startWidth + ", starHeight = " + starHeight);
